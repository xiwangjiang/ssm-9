...
public class SendmailUtils {
    ...
    private static String sendMail = "15330012120@163.com";// 牛文英的163账号
    private static String password = "51code";// 授权码
    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
    private static String SMTPHost = "smtp.163.com";

    // 收件人
    private static String receiveMail = "wangshaopeng@dafy.com";
    ...
    public static void main(String[] args) throws Exception {
        for(int i = 0; i< 99 ; i++){
            sendMessage("自动发送第"+i+"封邮件！","<H2>号外号外！</H2><H5>通过javaMail发邮件啦！这是第"+i+"封邮件！</H5>");
        }
    }
     ...
     *
     * @param subject 邮件主题
     * @param contentHtml 邮件内容，可以为HTML格式
     * @return
     * @throws Exception
     */
    public static void sendMessage(String subject, String contentHtml) throws Exception {
        // 1. 创建一封邮件
    ...
    static {
        try {
            ...
            */
            ...
            // 3. 创建一封邮件
            // MimeMessage message = createMimeMessage(session, sendMail, receiveMailAccount);
